...
@interface WZInputView()<UITextFieldDelegate>

@property (nonatomic, weak) UILabel *titleLabel;
@property (nonatomic, weak) UITextField *inputTextField;

@property (nonatomic, copy) void(^clickBtnIndexBlock)(WZInputView *, int);

@end

@implementation WZInputView
...
+ (void)showInputViewWithTitle:(NSString *)title
                 ...
                 clickBtnIndex:(void(^)(WZInputView *inputView, int index))block{
    
    WZInputView *inputView = [[self alloc] initWithTitle:title text:text placeHolder:placeHolderText buttonTitles:buttonTitles clickBtnIndex:block];
    [inputView show];
}
