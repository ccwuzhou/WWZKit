...
@implementation WZLetterItem

@end

@interface WZSearchController ()<UISearchResultsUpdating, UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource>
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    if (!self.searchController.active) {// 原
        WZLetterItem *letterItem = self.mLetterItems[section];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BOOL isLast = NO;
    if (!self.searchController.active) {// 原
        WZLetterItem *letterItem = self.mLetterItems[indexPath.section];
