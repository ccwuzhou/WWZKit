...
{
    WZTipView *tipView = [[self alloc] initWithTitle:title titleFont:titleFont lineSpacing:lineSpacing buttonTitles:buttonTitles clickButtonBlock:block];
    [tipView show];
}
