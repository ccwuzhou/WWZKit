...
@protocol WZMenuPopoverDelegate <NSObject>

@optional

- (void)menuPopover:(WZMenuPopover *)menuPopover didSelectedItemAtIndex:(NSUInteger)index;

@end


@interface WZMenuPopover : UIView

@property (nonatomic, weak) id<WZMenuPopoverDelegate> menuDelegate;
