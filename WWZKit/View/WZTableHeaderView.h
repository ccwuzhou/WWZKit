...
@class WZTableHeaderView;

@protocol WZTableHeaderViewDelegate <NSObject>
 ...
 *  tap headerView 回调
 */
- (void)didTapHeaderView:(WZTableHeaderView *)headerView;

@end

@interface WZTableHeaderView : UITableViewHeaderFooterView
...
@property (nonatomic, weak) id<WZTableHeaderViewDelegate> delegate;
