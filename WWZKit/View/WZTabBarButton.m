...
@interface WZBadgeView : UIButton
...
@property (nonatomic, weak) WZBadgeView *badgeView;
...
+ (instancetype)wwz_tabBarButtonWithItem:(WZTabBarItem *)item{
    ...
    WZTabBarButton *barButton = [self buttonWithType:UIButtonTypeCustom];
...
- (void)setItem:(WZTabBarItem *)item{
...
// 懒加载badgeView
- (WZBadgeView *)badgeView
{
    if (!_badgeView) {
        
        WZBadgeView *btn = [WZBadgeView buttonWithType:UIButtonTypeCustom];
