...
@implementation WZActionSheetView
...
{
    WZActionSheetView *sheetView = [[self alloc] initWithTitle:title cancelButtonTitle:cancelButtonTitle otherButtonTitles:otherButtonTitles clickButtonBlock:clickButtonBlock];
    [sheetView show];
}
