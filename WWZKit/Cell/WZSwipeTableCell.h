...
/** Transition types */
typedef NS_ENUM(NSInteger, WZSwipeTransition) {
    WZSwipeTransitionStatic = 0,
    WZSwipeTransitionBorder,
    WZSwipeTransitionDrag,
    WZSwipeTransitionClipCenter,
    WZSwipeTransitionRotate3D
};

/** Swipe directions */
typedef NS_ENUM(NSInteger, WZSwipeDirection) {
    WZSwipeDirectionLeftToRight = 0,
    WZSwipeDirectionRightToLeft
};

/** Swipe state */
typedef NS_ENUM(NSInteger, WZSwipeState) {
    WZSwipeStateNone = 0,
    WZSwipeStateSwipingLeftToRight,
    WZSwipeStateSwipingRightToLeft,
    WZSwipeStateExpandingLeftToRight,
    WZSwipeStateExpandingRightToLeft,
};

/** Swipe state */
typedef NS_ENUM(NSInteger, WZSwipeExpansionLayout) {
    WZSwipeExpansionLayoutBorder = 0,
    WZSwipeExpansionLayoutCenter
};

/** Swipe Easing Function */
typedef NS_ENUM(NSInteger, WZSwipeEasingFunction) {
    WZSwipeEasingFunctionLinear = 0,
    WZSwipeEasingFunctionQuadIn,
    WZSwipeEasingFunctionQuadOut,
    WZSwipeEasingFunctionQuadInOut,
    WZSwipeEasingFunctionCubicIn,
    WZSwipeEasingFunctionCubicOut,
    WZSwipeEasingFunctionCubicInOut,
    WZSwipeEasingFunctionBounceIn,
    WZSwipeEasingFunctionBounceOut,
    WZSwipeEasingFunctionBounceInOut
};

/**
 * Swipe animation settings
 **/
@interface WZSwipeAnimation : NSObject

/** Animation duration in seconds. Default value 0.3 */
@property (nonatomic, assign) CGFloat duration;

/** Animation easing function. Default value EaseOutBounce */
@property (nonatomic, assign) WZSwipeEasingFunction easingFunction;
 ...
 * Swipe settings
 **/
@interface WZSwipeSettings: NSObject

/** Transition used while swiping buttons */
@property (nonatomic, assign) WZSwipeTransition transition;
...
@property (nonatomic, strong) WZSwipeAnimation *showAnimation;

/** Animation settings when the swipe buttons are hided */
@property (nonatomic, strong) WZSwipeAnimation *hideAnimation;

/** Animation settings when the cell is stretched from the swipe buttons */
@property (nonatomic, strong) WZSwipeAnimation *stretchAnimation;
 ...
 **/
@interface WZSwipeExpansionSettings: NSObject
...
@property (nonatomic, assign) WZSwipeExpansionLayout expansionLayout;
/** Animation settings when the expansion is triggered **/
@property (nonatomic, strong) WZSwipeAnimation * triggerAnimation;
 ...
 */
@protocol WZSwipeTableCellDelegate <WZTableViewCellDelegate>
 ...
 **/
- (BOOL)swipeTableCell:(WZSwipeTableCell*)cell canSwipe:(WZSwipeDirection) direction fromPoint:(CGPoint) point;
- (BOOL)swipeTableCell:(WZSwipeTableCell*)cell canSwipe:(WZSwipeDirection) direction DEPRECATED_ATTRIBUTE; //backwards compatibility
 ...
 **/
- (void)swipeTableCell:(WZSwipeTableCell*)cell
   didChangeSwipeState:(WZSwipeState)state
 ...
 **/
- (BOOL)swipeTableCell:(WZSwipeTableCell*)cell
   tappedButtonAtIndex:(NSInteger)index
             direction:(WZSwipeDirection)direction
 ...
 **/
- (NSArray *)swipeTableCell:(WZSwipeTableCell*)cell
   swipeButtonsForDirection:(WZSwipeDirection)direction
              swipeSettings:(WZSwipeSettings*)swipeSettings
          expansionSettings:(WZSwipeExpansionSettings*)expansionSettings;

/**
 * Called when the user taps on a swiped cell
 * @return YES to autohide the current swipe buttons
 **/
- (BOOL)swipeTableCell:(WZSwipeTableCell *)cell shouldHideSwipeOnTap:(CGPoint) point;

/**
 * Called when the cell will begin swiping
 * Useful to make cell changes that only are shown after the cell is swiped open
 **/
- (void)swipeTableCellWillBeginSwiping:(WZSwipeTableCell *) cell;

/**
 * Called when the cell will end swiping
 **/
- (void)swipeTableCellWillEndSwiping:(WZSwipeTableCell *) cell;
 ...
 */
@interface WZSwipeTableCell : WZTableViewCell

/** optional delegate (not retained) */
@property (nonatomic, weak) id<WZSwipeTableCellDelegate> swipeDelegate;
...
@property (nonatomic, strong) WZSwipeSettings * leftSwipeSettings;
@property (nonatomic, strong) WZSwipeSettings * rightSwipeSettings;

/** Optional settings to allow expandable buttons */
@property (nonatomic, strong) WZSwipeExpansionSettings * leftExpansion;
@property (nonatomic, strong) WZSwipeExpansionSettings * rightExpansion;

/** Readonly property to fetch the current swipe state */
@property (nonatomic, readonly) WZSwipeState swipeState;
 ...
 * @param usingDelegate if YES new buttons will be fetched using the WZSwipeTableCellDelegate. Otherwise new buttons will be fetched from leftButtons/rightButtons properties.
 */
