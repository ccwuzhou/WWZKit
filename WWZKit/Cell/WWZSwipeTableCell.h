...
/** Transition types */
typedef NS_ENUM(NSInteger, WWZSwipeTransition) {
    WWZSwipeTransitionStatic = 0,
    WWZSwipeTransitionBorder,
    WWZSwipeTransitionDrag,
    WWZSwipeTransitionClipCenter,
    WWZSwipeTransitionRotate3D
};

/** Swipe directions */
typedef NS_ENUM(NSInteger, WWZSwipeDirection) {
    WWZSwipeDirectionLeftToRight = 0,
    WWZSwipeDirectionRightToLeft
};

/** Swipe state */
typedef NS_ENUM(NSInteger, WWZSwipeState) {
    WWZSwipeStateNone = 0,
    WWZSwipeStateSwipingLeftToRight,
    WWZSwipeStateSwipingRightToLeft,
    WWZSwipeStateExpandingLeftToRight,
    WWZSwipeStateExpandingRightToLeft,
};

/** Swipe state */
typedef NS_ENUM(NSInteger, WWZSwipeExpansionLayout) {
    WWZSwipeExpansionLayoutBorder = 0,
    WWZSwipeExpansionLayoutCenter
};

/** Swipe Easing Function */
typedef NS_ENUM(NSInteger, WWZSwipeEasingFunction) {
    WWZSwipeEasingFunctionLinear = 0,
    WWZSwipeEasingFunctionQuadIn,
    WWZSwipeEasingFunctionQuadOut,
    WWZSwipeEasingFunctionQuadInOut,
    WWZSwipeEasingFunctionCubicIn,
    WWZSwipeEasingFunctionCubicOut,
    WWZSwipeEasingFunctionCubicInOut,
    WWZSwipeEasingFunctionBounceIn,
    WWZSwipeEasingFunctionBounceOut,
    WWZSwipeEasingFunctionBounceInOut
};

/**
 * Swipe animation settings
 **/
@interface WWZSwipeAnimation : NSObject

/** Animation duration in seconds. Default value 0.3 */
@property (nonatomic, assign) CGFloat duration;

/** Animation easing function. Default value EaseOutBounce */
@property (nonatomic, assign) WWZSwipeEasingFunction easingFunction;
 ...
 * Swipe settings
 **/
@interface WWZSwipeSettings: NSObject

/** Transition used while swiping buttons */
@property (nonatomic, assign) WWZSwipeTransition transition;
...
@property (nonatomic, strong) WWZSwipeAnimation *showAnimation;

/** Animation settings when the swipe buttons are hided */
@property (nonatomic, strong) WWZSwipeAnimation *hideAnimation;

/** Animation settings when the cell is stretched from the swipe buttons */
@property (nonatomic, strong) WWZSwipeAnimation *stretchAnimation;
 ...
 **/
@interface WWZSwipeExpansionSettings: NSObject
...
@property (nonatomic, assign) WWZSwipeExpansionLayout expansionLayout;
/** Animation settings when the expansion is triggered **/
@property (nonatomic, strong) WWZSwipeAnimation * triggerAnimation;
 ...
 */
@protocol WWZSwipeTableCellDelegate <WWZTableViewCellDelegate>
 ...
 **/
- (BOOL)swipeTableCell:(WWZSwipeTableCell*)cell canSwipe:(WWZSwipeDirection) direction fromPoint:(CGPoint) point;
- (BOOL)swipeTableCell:(WWZSwipeTableCell*)cell canSwipe:(WWZSwipeDirection) direction DEPRECATED_ATTRIBUTE; //backwards compatibility
 ...
 **/
- (void)swipeTableCell:(WWZSwipeTableCell*)cell
   didChangeSwipeState:(WWZSwipeState)state
 ...
 **/
- (BOOL)swipeTableCell:(WWZSwipeTableCell*)cell
   tappedButtonAtIndex:(NSInteger)index
             direction:(WWZSwipeDirection)direction
 ...
 **/
- (NSArray *)swipeTableCell:(WWZSwipeTableCell*)cell
   swipeButtonsForDirection:(WWZSwipeDirection)direction
              swipeSettings:(WWZSwipeSettings*)swipeSettings
          expansionSettings:(WWZSwipeExpansionSettings*)expansionSettings;

/**
 * Called when the user taps on a swiped cell
 * @return YES to autohide the current swipe buttons
 **/
- (BOOL)swipeTableCell:(WWZSwipeTableCell *)cell shouldHideSwipeOnTap:(CGPoint) point;

/**
 * Called when the cell will begin swiping
 * Useful to make cell changes that only are shown after the cell is swiped open
 **/
- (void)swipeTableCellWillBeginSwiping:(WWZSwipeTableCell *) cell;

/**
 * Called when the cell will end swiping
 **/
- (void)swipeTableCellWillEndSwiping:(WWZSwipeTableCell *) cell;
 ...
 */
@interface WWZSwipeTableCell : WWZTableViewCell

/** optional delegate (not retained) */
@property (nonatomic, weak) id<WWZSwipeTableCellDelegate> swipeDelegate;
...
@property (nonatomic, strong) WWZSwipeSettings * leftSwipeSettings;
@property (nonatomic, strong) WWZSwipeSettings * rightSwipeSettings;

/** Optional settings to allow expandable buttons */
@property (nonatomic, strong) WWZSwipeExpansionSettings * leftExpansion;
@property (nonatomic, strong) WWZSwipeExpansionSettings * rightExpansion;

/** Readonly property to fetch the current swipe state */
@property (nonatomic, readonly) WWZSwipeState swipeState;
 ...
 * @param usingDelegate if YES new buttons will be fetched using the WWZSwipeTableCellDelegate. Otherwise new buttons will be fetched from leftButtons/rightButtons properties.
 */
